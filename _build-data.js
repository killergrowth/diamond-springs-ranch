...
const SERVICES = [
  ...
  },
  {
    ...
    body:       '<p>We designed the Sunset Reset Treehouse from the ground up. Not as an amenity. Not as a feature. As something that would genuinely give people a reason to stop, breathe, and come back to themselves. It sits perched up in a stand of cottonwoods on the open ranch &mdash; wraparound deck, views of the prairie in every direction, spring-fed creek close enough to hear at night. Designed by a Treehouse Masters producer. Built by us.</p><p>The guestbook inside says it better than we ever could. Couples who&rsquo;d barely been present with each other in months. Kids who still talk about that night as one of their favorites. Anniversary guests who planned to stay one night and wished they&rsquo;d booked two. That&rsquo;s what we were going for when we built it. Not luxury for luxury&rsquo;s sake. Just a real reset &mdash; fifteen minutes from the city, a world away from everything else.</p><p>This is not your average Airbnb. We book it direct. Spring and fall, it fills weeks out. If you&rsquo;re planning something special, call ahead &mdash; (316) 303-6195. We&rsquo;ll check what&rsquo;s open and help you build the rest of the stay around it.</p><h2>Booking the Treehouse</h2><p>All stays are by reservation. We can pair a treehouse night with a morning trail ride, a Highland cattle encounter, the Dinner Date Experience, or just an evening bonfire out on the property. Tell us what you&rsquo;re going for and we&rsquo;ll make it happen.</p><h2>Where Are We?</h2><p>Diamond Springs Ranch, 1734 SE 96th St, Sedgwick, KS 67135. Fifteen minutes north of Wichita, 2 miles off I-135. Fully insured, reservation-only.</p><h2>What Makes It Unique?</h2><p>There&rsquo;s nothing else like it near Wichita. A fully equipped, fully private treehouse on a real working ranch &mdash; no neighbors visible, no road noise, just open Kansas land and a sky you&rsquo;d forgotten existed. Guests who&rsquo;ve stayed in the nicest places in the country come back saying this one stood out. That&rsquo;s the whole point.</p><p>More to explore: <a href="/guided-horseback-rides/">Guided Horseback Rides</a>, <a href="/highland-cattle-experience/">Highland Cattle Experience</a>, <a href="/covered-wagon-stay/">Covered Wagon Stay</a>, <a href="/private-events/">Private Events</a>, <a href="/dinner-date-experience/">Dinner Date Experience</a>. See all <a href="/services/">ranch experiences</a> and <a href="/service-areas/">areas we serve</a>.</p>',
