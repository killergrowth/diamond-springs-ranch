...
const CLIENT = {
  ...
  email:           'Diamondspringsranch1@gmail.com',
  ...
  hours:           'By Reservation Only &mdash; <a href="/contact/">contact us</a> or <a href="https://fareharbor.com/embeds/book/diamondspringsranch/items/?full-items=yes" target="_blank">book online</a>',
  founderName:     'Logan Schrag',
  yearFounded:     '2016',
  license:         'All Activities by Reservation',
  ...
  homepageDescription: 'Diamond Springs Ranch in Sedgwick, KS: horseback rides, Highland cattle, treehouse stays &amp; private events. 15 minutes north of Wichita.',
...
const SERVICES = [
  {
    ...
    heroBg:     '/images/hero-rides.png',
    heroHeading: 'Get your cowboy on.',
    ...
    icon:       '&#x1F40E;',
    costRange:  '<a href="/contact/">Contact us</a> or <a href="https://fareharbor.com/embeds/book/diamondspringsranch/items/?full-items=yes" target="_blank">Book Now</a>',
    ...
    faqs: [
      ...
      { q: 'How long are the trail rides?', a: 'It depends on what you book. <a href="/contact/">Contact us</a> and we&rsquo;ll talk through the options. Sunset rides are timed to the season.' },
      ...
      { q: 'Can kids ride?', a: 'Yes. Kids ride with us regularly. <a href="/contact/">Contact us</a> to confirm age and weight requirements &mdash; those vary depending on the horse and the type of ride.' },
      { q: 'Do you offer riding lessons?', a: 'Yes &mdash; lessons for beginners through intermediate riders, by reservation. <a href="/contact/">Contact us</a> to set something up.' },
    ],
  },
  {
    ...
    ctaLabel:   'Book the Highland Experience',
    ...
    body:       '<p>With their long horns, shaggy coats, and gentle personalities, our Scottish Highland cattle have become some of the most loved animals on the ranch. They&rsquo;re part of everyday life here, accustomed to being around people, and each one seems to have a personality of its own.</p><p>The Highland Experience gives you a chance to slow down and spend some time with them &mdash; feeding, brushing, taking photos, and getting closer than most people ever have to cattle like these.</p><p>For kids, it can be a completely new experience. For adults, it&rsquo;s often just as memorable. There&rsquo;s something about standing in the pasture beside one of these big, shaggy animals that brings out a smile.</p><p>They&rsquo;ve become one of the most photographed parts of Diamond Springs Ranch, but pictures are only part of it. There&rsquo;s just something about meeting a Highland in person.</p><h2>Who Books the Cattle Experience?</h2><p>Families, couples, church groups, school field trips, photography enthusiasts who hear about the Highlands and make the drive specifically for them. It&rsquo;s available standalone or paired with a trail ride for a full day on the ranch. Either way, <a href="/contact/">contact us</a> to get it on the calendar.</p><h2>Where Are We?</h2><p>Diamond Springs Ranch, 1734 SE 96th St, Sedgwick, KS 67135. Fifteen minutes north of Wichita, 2 miles off I-135. Reservation-only.</p><p>More to explore: <a href="/guided-horseback-rides/">Guided Horseback Rides</a>, <a href="/luxury-treehouse-stay/">Luxury Treehouse Stay</a>, <a href="/covered-wagon-stay/">Covered Wagon Stay</a>, <a href="/private-events/">Private Events</a>, <a href="/dinner-date-experience/">Dinner Date Experience</a>. See all <a href="/services/">ranch experiences</a> and <a href="/service-areas/">areas we serve</a>.</p>',
    ...
    faqs: [
      ...
      { q: 'Is it available year-round?', a: 'Seasonal and by reservation. <a href="/contact/">Contact us</a> to check availability for your date.' },
      ...
      { q: 'How long does it last?', a: 'Depends on the reservation. <a href="/contact/">Contact us</a> and we&rsquo;ll walk you through the options and how to combine it with other activities.' },
    ],
  },
  {
    ...
    icon:       '&#x1F333;',
    costRange:  '<a href="https://treelodges.lodgify.com/en/sunset-reset-treehouse" target="_blank">Book Now</a> or <a href="/contact/">Contact Us</a>',
    ...
    metaDescription: 'Luxury treehouse overnight stay at Diamond Springs Ranch near Wichita, KS. Private, fully equipped, one-of-a-kind in Sedgwick, Kansas. Reserve online today.',
    faqs: [
      { q: 'What&rsquo;s included in the treehouse stay?', a: 'It&rsquo;s fully set up for a comfortable overnight. <a href="/contact/">Contact us</a> for the specifics &mdash; amenities get updated and we&rsquo;d rather tell you directly than have you read something outdated.' },
      ...
      { q: 'Can I add ranch activities to the overnight?', a: 'Yes &mdash; most guests do. Trail ride, cattle encounter, dinner date, bonfire. Just mention what you&rsquo;re interested in when you <a href="/contact/">contact us</a>.' },
      { q: 'Is it available in winter?', a: 'It varies. <a href="/contact/">Contact us</a> to check. We&rsquo;re open during select periods in the off-season.' },
    ],
  },
  {
    ...
    icon:       '&#x1F6FA;',
    costRange:  '<a href="https://treelodges.lodgify.com/en/sunset-schooner" target="_blank">Book Now</a> or <a href="/contact/">Contact Us</a>',
    ...
    body:       '<p>We built the Sunset Schooner for people who want to experience something a little different &mdash; a taste of the pioneer life, without leaving the comforts of today behind.</p><p>Tucked beneath the trees on our working Kansas ranch, the covered wagon feels like its own little world. Leave your car behind, load your things onto one of our ranch carts, and make your way down to the wagon. Waiting for you is a real bed, private bathroom, heat and A/C, a grill and fire pit, and an elevated, west-facing deck made for watching the Kansas sun disappear over the pasture.</p><p>The Schooner sleeps four and has become a favorite for couples and families alike. Kids get to spend the night in something they&rsquo;ve only seen in books and movies. Adults get something that can be even harder to find &mdash; a reason to slow down.</p><p>As evening settles over the ranch, light fades across the pasture, the fire gets going, and the stars begin to come out through the trees. Out here, there&rsquo;s nowhere you need to be and not much demanding your attention.</p><p>That&rsquo;s a big part of why we built this place.</p><p>We wanted to give people a chance to experience a little of the cowboy way of life &mdash; when things moved slower, evenings were spent outside, and what mattered most was usually right in front of you.</p><p>Leave the car behind. Slow down. Stay awhile.</p><h2>Where Are We?</h2><p>Diamond Springs Ranch, 1734 SE 96th St, Sedgwick, KS 67135. Fifteen minutes north of Wichita, 2 miles off I-135. Reservation-only.</p><p>More to explore: <a href="/guided-horseback-rides/">Guided Horseback Rides</a>, <a href="/highland-cattle-experience/">Highland Cattle Experience</a>, <a href="/luxury-treehouse-stay/">Luxury Treehouse Stay</a>, <a href="/private-events/">Private Events</a>, <a href="/dinner-date-experience/">Dinner Date Experience</a>. See all <a href="/services/">ranch experiences</a> and <a href="/service-areas/">areas we serve</a>.</p>',
    metaDescription: 'Covered wagon overnight stay at Diamond Springs Ranch near Wichita, KS. A one-of-a-kind Western overnight in Sedgwick, Kansas. Reserve online today.',
    faqs: [
      { q: 'What&rsquo;s included in the covered wagon stay?', a: 'The wagon is fully set up for overnight. <a href="/contact/">Contact us</a> for the specifics &mdash; we&rsquo;d rather tell you directly.' },
      ...
      { q: 'Can I add trail rides or a bonfire?', a: 'Absolutely. Most guests do. <a href="/contact/">Contact us</a> and we&rsquo;ll put together whatever combination works for you.' },
      { q: 'How far in advance should I book?', a: 'Spring and fall weekends book fast. A few weeks out minimum for those months. <a href="/contact/">Contact us</a> to check what&rsquo;s open.' },
    ],
  },
  {
    slug:       'private-events',
    heroBg:     '/images/The_House_at_Night2.png',
    heroHeading: 'Gather Somewhere <em>Different.</em>',
    ...
    icon:       '&#x1F37E;',
    costRange:  '<a href="/contact/">Contact us</a> for custom event pricing',
    intro:      'Corporate retreats, family reunions, birthday parties, church groups, school field trips &mdash; we&rsquo;ve hosted all of it. The ranch setting makes every gathering better than it would have been anywhere else.',
    body:       '<h2>Corporate Retreats &amp; Team Building</h2><p>There&rsquo;s something about getting your team out of the office and onto a working ranch that changes the dynamic. We&rsquo;ve welcomed medical practices, agriculture companies, professional service firms, logistics teams, and others from across the Wichita area &mdash; including groups that return year after year.</p><p>Whether you&rsquo;re planning a team day for 8, a company gathering for 60+, or something that takes over the whole ranch, we can help you put together an experience that fits your group.</p><p>Tell us a little about what you have in mind, and we&rsquo;ll take it from there.</p><p><a href="/event-inquiry/" class="dsr-inline-cta">Plan Your Group Experience</a></p><h2>Groups, Gatherings &amp; Everything Else</h2><p>Church groups, school field trips, scout troops, family reunions, birthday parties, photography sessions &mdash; if you have a group and an idea, there&rsquo;s a good chance we can help make it happen.</p><p>Every gathering is a little different, so start by telling us what you&rsquo;re planning, your group size, and when you&rsquo;d like to come. We&rsquo;ll help you figure out what works best at the ranch.</p><p><a href="/event-inquiry/" class="dsr-inline-cta">Tell Us What You&rsquo;re Planning</a></p><h2>Where Are We?</h2><p>Diamond Springs Ranch, 1734 SE 96th St, Sedgwick, KS 67135 &mdash; fifteen minutes north of Wichita, 2 miles off I-135. Reservation-only.</p><p>More to explore: <a href="/guided-horseback-rides/">Guided Horseback Rides</a>, <a href="/highland-cattle-experience/">Highland Cattle Experience</a>, <a href="/luxury-treehouse-stay/">Luxury Treehouse Stay</a>, <a href="/covered-wagon-stay/">Covered Wagon Stay</a>, <a href="/dinner-date-experience/">Dinner Date Experience</a>. See all <a href="/services/">ranch experiences</a> and <a href="/service-areas/">areas we serve</a>.</p>',
    metaDescription: 'Private ranch events near Wichita &mdash; corporate retreats, family reunions, birthday parties at Diamond Springs Ranch in Sedgwick, KS..',
    faqs: [
      { q: 'What kinds of events do you host?', a: 'Corporate retreats, team-building, family reunions, birthday parties, church groups, school field trips, scout groups, company picnics, and photography sessions. <a href="/contact/">Contact us</a> to talk through your specific event.'},
      { q: 'How many people can you accommodate?', a: 'Depends on the event. <a href="/contact/">Contact us</a> and we can talk through your group size and what setup works best.' },
      { q: 'Do you host corporate retreats near Wichita?', a: 'Yes. Corporate teams make up a solid part of our events calendar. The ranch setting creates a different dynamic than any conference room. <a href="/contact/">Contact us</a> to get started.' },
      { q: 'Can we do a bonfire or s&rsquo;mores night?', a: 'Yes. Bonfire nights are available as part of private events and overnight stays. We also do seasonal live music events. <a href="/contact/">Ask us when you reach out</a>.' },
    ],
  },
  {
    ...
    faqs: [
      ...
      { q: 'How far out should I book?', a: 'Weekend dates book fast in spring and fall. At least 2&ndash;3 weeks out is smart for weekend evenings. <a href="/contact/">Contact us</a> to check availability.' },
      { q: 'Can I combine it with an overnight stay?', a: 'Yes &mdash; pairing the Dinner Date with the treehouse or covered wagon is one of our most popular combinations. <a href="/contact/">Contact us</a> and we&rsquo;ll put it together.' },
      { q: 'Is it available year-round?', a: 'It varies by season. <a href="/contact/">Contact us</a> to check what&rsquo;s available for your time of year.' },
    ],
  },

  {
    ...
    faqs: [
      ...
      { q: 'How long are lessons?', a: 'Session length and structure depend on your goals. <a href="/contact/">Contact us</a> and we&rsquo;ll talk through what makes sense for you.' },
      { q: 'How do I book?', a: 'By reservation only. <a href="/contact/">Contact us</a> or <a href="https://fareharbor.com/embeds/book/diamondspringsranch/items/?full-items=yes" target="_blank">book now online</a>. Walk-ins are not available.' },
    ],
  },
  {
    slug:       'horse-day-camp',
    ...
    icon:       '&#x1F3D5;',
    costRange:  '<a href="/contact/">Contact us</a> for current session dates',
    ...
    faqs: [
      ...
      { q: 'How many spots are available per session?', a: 'Spots are limited intentionally to keep the ratio of kids to instructors and horses real. <a href="/contact/">Contact us early</a> to reserve your spot.' },
      ...
      { q: 'When do sessions run?', a: 'Primarily summer. <a href="/contact/">Contact us</a> for current session dates and availability.' },
    ],
  },
  {
    ...
    name:       'Private Events and Rentals',
    shortDesc:  'On-site bar available for private events, corporate retreats, and group bookings at Diamond Springs Ranch.',
    icon:       '&#x1F37B;',
    costRange:  'Available for private events &mdash; <a href="/contact/">contact us</a> to inquire',
    ...
    body:       '<p>The Rusty Saddle Bar brings the full ranch experience together. Whether you&rsquo;re winding down after a trail ride, celebrating a private event, or hosting a corporate retreat, it&rsquo;s the spot to gather and enjoy the ranch atmosphere at its best.</p><p>Available for private bookings alongside our other event services. Ask about including the Rusty Saddle Bar in your private event or group package when you <a href="/contact/">reach out</a>.</p><h2>Private Events &amp; Group Bookings</h2><p>The Rusty Saddle Bar is available as part of private event rentals at Diamond Springs Ranch. Contact us to discuss availability and packages for your group.</p><h2>Where Are We?</h2><p>Diamond Springs Ranch, 1734 SE 96th St, Sedgwick, KS 67135. About 15 minutes north of Wichita, 2 miles off I-135.</p>',
    metaDescription: 'The Rusty Saddle Bar at Diamond Springs Ranch near Wichita, KS. On-site bar available for private events, corporate retreats, and group bookings..',
    faqs: [
      { q: 'Is the Rusty Saddle Bar open to the public?', a: 'The Rusty Saddle Bar is available as part of private event bookings. <a href="/contact/">Contact us</a> to ask about availability for your group.' },
...
const CITIES = [
  {
    ...
    faqs: [
      ...
      { q: 'Can Wichita companies use the ranch for corporate retreats?', a: 'Yes &mdash; corporate retreats and team-building from Wichita businesses are a regular part of our calendar. Open land, shared activities, no conference room energy. <a href="/contact/">Contact us</a> to plan.' },
      ...
      { q: 'Best time of year to visit?', a: 'Spring and fall are the most popular &mdash; great weather for rides and outdoor experiences. Summer brings horse camps and evening events. Winter varies; <a href="/contact/">contact us</a> to check.' },
    ],
  },
  {
    slug:        'derby-ks',
    ...
    faqs: [
      ...
      { q: 'Do you host Derby school groups and field trips?', a: 'Yes. <a href="/contact/">Contact us</a> to plan a group visit.' },
      { q: 'Can Derby businesses use the ranch for team-building?', a: 'Yes. <a href="/contact/">Contact us</a> to get started.' },
  ...
  },
  {
    ...
    lat:          37.5651,
    lng:         -97.3519,
    intro:       'Diamond Springs Ranch is 35 minutes north of Haysville on US-81 &mdash; the closest working ranch experience for southern Harvey County families. Horseback rides, Highland cattle, treehouse stays, and private events.',
    metaDescription: 'Ranch experiences for Haysville, KS families at Diamond Springs Ranch in Sedgwick. Horseback rides, Highland cattle, and more..',
    body:        '<p>Haysville is about 35 minutes south of us via US-81 North. Families from South Haysville, the Lake Afton area, and the Clearwater Road corridor make the drive for trail rides, birthday outings, and anniversary experiences they can&rsquo;t find any closer to home.</p><p>Church and faith communities from Haysville use the ranch for outdoor retreats and summer programming. School groups come for field trips combining animal encounters with open-air learning.</p><h2>Why Do Haysville Residents Visit Diamond Springs Ranch?</h2><p>Haysville is a tight-knit community south of Wichita with no working ranch experiences nearby. We give Haysville families, school groups, and corporate teams access to real Kansas ranch life &mdash; horseback rides, Highland cattle, bonfire nights, treehouse stays, and full private event rental &mdash; in a 35-minute drive north.</p><h2>What Is Diamond Springs Ranch?</h2><p>1734 SE 96th St, Sedgwick, KS 67135. All experiences by reservation. <a href="/contact/">Contact us</a> or <a href="https://fareharbor.com/embeds/book/diamondspringsranch/items/?full-items=yes" target="_blank">book now</a>.</p><h2>Book from Haysville</h2><p>All by reservation: <a href="/guided-horseback-rides/">Guided Horseback Rides</a>, <a href="/highland-cattle-experience/">Highland Cattle Experience</a>, <a href="/luxury-treehouse-stay/">Luxury Treehouse Stay</a>, <a href="/covered-wagon-stay/">Covered Wagon Stay</a>, <a href="/private-events/">Private Events</a>, and <a href="/dinner-date-experience/">Dinner Date Experience</a>. See all <a href="/services/">ranch experiences</a>.</p>',
    ...
    faqs: [
      ...
      { q: 'Can Haysville church groups book the ranch?', a: 'Yes. <a href="/contact/">Contact us</a> to book.' },
      { q: 'Do you host Haysville school field trips?', a: 'Yes. <a href="/contact/">Contact us</a> to discuss scheduling.' },
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: 'Can Andover businesses use the ranch for corporate retreats?', a: 'Yes. <a href="/contact/">Contact us</a> to get started.' },
      ...
      { q: 'Do you host Andover school and scout groups?', a: 'Yes. <a href="/contact/">Contact us</a> to plan.' },
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: 'Can Newton church groups book the ranch for retreats?', a: 'Yes. <a href="/contact/">Contact us</a> to book.' },
      ...
      { q: 'Can Newton residents make a last-minute reservation?', a: 'The proximity makes it more feasible than for most. <a href="/contact/">Contact us</a> or <a href="https://fareharbor.com/embeds/book/diamondspringsranch/items/?full-items=yes" target="_blank">book now</a> to check current availability.' },
...
const SERVICE_FAQS = [
  ...
  { q: 'Is the ranch good for corporate team-building?', a: 'Yes &mdash; corporate retreats and team events are a regular part of our calendar. Getting a team on a working ranch changes the dynamic completely. <a href="/contact/">Contact us</a> to discuss.' },
];
