...
const CLIENT = {
  ...
  aboutBody:       '<p>We started Diamond Springs Ranch to allow people the space to slow down from the fast pace of life. We want people to come back to the cowboy way of life &mdash; when everything was much slower, and what mattered was right in front of you.</p><p>This is not a theme park. Not a petting zoo. It&rsquo;s a real, working ranch that we built from nothing &mdash; designed the treehouse, raised the lodge from the ground up, grew the trail string one horse at a time, and raised every one of our Highland cattle. My family&rsquo;s fingerprints are on all of it. Ashley&rsquo;s. Mine. The boys&rsquo;.</p><p>Our hope is that when you come out here, you&rsquo;d encounter something real. The horses know this land. The guides ride them every single day. Our cattle aren&rsquo;t seasonal. We don&rsquo;t put on a show &mdash; we just open the gates and let the ranch do what it&rsquo;s always done.</p><p>We are kind, respectful, and friendly to everyone. Beginner or expert rider alike. From our family to yours.</p><p>Everything is by reservation only &mdash; call or text (316) 303-6195.</p>',
  trustItems: [
...
const SERVICES = [
  ...
  },
  {
    ...
    body:       '<p>Scottish Highland cattle aren&rsquo;t like regular cattle. They have a presence. Long curved horns, thick shaggy coats, and a temperament that&rsquo;s genuinely calm &mdash; they&rsquo;re comfortable around people because they&rsquo;re around people every day. That&rsquo;s what makes the Ranch Corral Experience work. You&rsquo;re not watching from a fence. You&rsquo;re in there with them.</p><p>Guests feed them, brush them, and photograph them out in the open pasture. Kids who have never been closer to a large animal than a petting zoo fence tend to light up. Adults who came primarily for the trail ride will often say the cattle were the highlight of the whole visit. Both show up in our reviews constantly.</p><p>Honestly, this is probably our most-photographed experience. The cattle are striking and they know how to work a camera. If you want a photo that nobody in your family has seen before, this is it.</p><h2>Who Books the Cattle Experience?</h2><p>Families, couples, school groups, church groups, and photography enthusiasts who hear about the Highlands and make the drive specifically for them. It&rsquo;s available as a standalone or paired with a morning trail ride for a full ranch day. Call (316) 303-6195 to book.</p><h2>Where Are We?</h2><p>Diamond Springs Ranch, 1734 SE 96th St, Sedgwick, KS 67135. About 15 minutes north of Wichita. Fully insured, reservation-only.</p><p>More to explore: <a href="/guided-horseback-rides/">Guided Horseback Rides</a>, <a href="/luxury-treehouse-stay/">Luxury Treehouse Stay</a>, <a href="/covered-wagon-stay/">Covered Wagon Stay</a>, <a href="/private-events/">Private Events</a>, <a href="/dinner-date-experience/">Dinner Date Experience</a>. See all <a href="/services/">ranch experiences</a> and <a href="/service-areas/">areas we serve</a>.</p>',
  ...
  },
  {
    ...
    body:       '<p>We built the Sunset Reset Treehouse ourselves, up in a stand of mature cottonwoods on the open pasture. It sits above the ranch with unobstructed views of Kansas land in every direction &mdash; fully set up for a comfortable night and completely private from everything else happening on the property below.</p><p>The guestbook inside tells the story better than we can. Couples who said they hadn&rsquo;t really been present with each other in months. Families whose kids still talk about that night as one of their favorites. Anniversary guests who planned to stay one night and wished they&rsquo;d booked two. That&rsquo;s the experience we built this for.</p><p>Spring and fall are the most popular times. Weekend dates fill up weeks out during those months &mdash; if you&rsquo;re planning an anniversary or a special occasion, don&rsquo;t wait. Call or text (316) 303-6195 to check what&rsquo;s available.</p><h2>Booking the Treehouse</h2><p>All stays are by reservation. We can pair the treehouse with a morning trail ride, a cattle encounter, a dinner date experience, or a bonfire on the property. Just tell us what you&rsquo;re going for when you call.</p><h2>Where Are We?</h2><p>Diamond Springs Ranch, 1734 SE 96th St, Sedgwick, KS 67135. About 15 minutes north of Wichita. Fully insured, reservation-only.</p><h2>What Makes It Unique?</h2><p>It&rsquo;s one of a kind in the Wichita area &mdash; a fully furnished treehouse elevated above a working Kansas ranch, with views of open prairie in every direction. No neighboring structures visible at night. Guests describe it as genuinely off-grid, even though it&rsquo;s only 15 minutes from the city. We book it direct &mdash; no short-term rental platforms. Spring through fall, it fills fast.</p><p>More to explore: <a href="/guided-horseback-rides/">Guided Horseback Rides</a>, <a href="/highland-cattle-experience/">Highland Cattle Experience</a>, <a href="/covered-wagon-stay/">Covered Wagon Stay</a>, <a href="/private-events/">Private Events</a>, <a href="/dinner-date-experience/">Dinner Date Experience</a>. See all <a href="/services/">ranch experiences</a> and <a href="/service-areas/">areas we serve</a>.</p>',
  ...
  },
  {
    ...
    icon:       '&#x1F6FA;',
    costRange:  'Call for current nightly rates &mdash; (316) 303-6195',
    intro:      'There&rsquo;s nothing else like this near Wichita. The Sunset Schooner sits on the open pasture &mdash; fully set up for a comfortable night, with a Kansas sky overhead that reminds you how big this state really is. Families love it. Couples love it. If you&rsquo;ve never slept under an open Kansas sky, this is where to start.',
    body:       '<p>The Sunset Schooner sits out on the open pasture, positioned where there&rsquo;s nothing between you and the Kansas sky in any direction. It&rsquo;s fully set up for a comfortable stay &mdash; this isn&rsquo;t rough camping. But it&rsquo;s not a hotel room either. It&rsquo;s something in between that most people don&rsquo;t have a word for until they&rsquo;ve done it.</p><p>Guests describe it as the kind of experience that resets something. The scale of the night sky, the sounds of the ranch at night, the complete break from normal. Kids who grew up reading about covered wagons and the Oregon Trail discover that the real thing &mdash; scaled for a family &mdash; is better than the books made it sound.</p><p>Spring and fall weekends fill up fast. If you want a specific date, call ahead. Most guests pair the wagon with a morning trail ride or a bonfire the evening before. Call or text (316) 303-6195 to check availability and build your stay.</p><h2>Where Are We?</h2><p>Diamond Springs Ranch, 1734 SE 96th St, Sedgwick, KS 67135. About 15 minutes north of Wichita. Fully insured, reservation-only.</p><p>More to explore: <a href="/guided-horseback-rides/">Guided Horseback Rides</a>, <a href="/highland-cattle-experience/">Highland Cattle Experience</a>, <a href="/luxury-treehouse-stay/">Luxury Treehouse Stay</a>, <a href="/private-events/">Private Events</a>, <a href="/dinner-date-experience/">Dinner Date Experience</a>. See all <a href="/services/">ranch experiences</a> and <a href="/service-areas/">areas we serve</a>.</p>',
  ...
  },
  {
    ...
    body:       '<p>There&rsquo;s something that happens when you get a group of people onto a working ranch. The conversation changes. The phones go away. People actually look at each other. We&rsquo;ve seen it happen with corporate teams, family reunions, church groups, and birthday parties &mdash; the setting does something that no conference room or event hall can replicate.</p><h2>Corporate Retreats and Team-Building</h2><p>We host corporate groups from across the Wichita metro &mdash; medical practices, ag businesses, logistics companies, professional service firms. Getting your team out of the office and onto a working ranch changes the dynamic. Several of our corporate clients come back every year specifically because of what the ranch setting does for their team. Groups from 8 to 60 for team events; full-property rental handles up to 150+. Call (316) 303-6195 to discuss your event.</p><h2>Groups, Gatherings, and Everything Else</h2><p>Church groups, school field trips, scout troops, family reunions, company picnics, birthday parties, photography sessions &mdash; the ranch has the space and the Rusty Saddle Bar on site to make it work. Peak months (May, June, September, October) book out early; off-season dates are usually available on shorter notice. Call (316) 303-6195 to talk through what you need.</p><h2>Where Are We?</h2><p>Diamond Springs Ranch, 1734 SE 96th St, Sedgwick, KS 67135 &mdash; about 15 minutes north of Wichita. Fully insured, reservation-only.</p><p>More to explore: <a href="/guided-horseback-rides/">Guided Horseback Rides</a>, <a href="/highland-cattle-experience/">Highland Cattle Experience</a>, <a href="/luxury-treehouse-stay/">Luxury Treehouse Stay</a>, <a href="/covered-wagon-stay/">Covered Wagon Stay</a>, <a href="/dinner-date-experience/">Dinner Date Experience</a>. See all <a href="/services/">ranch experiences</a> and <a href="/service-areas/">areas we serve</a>.</p>',
  ...
  },
  {
    ...
    body:       '<p>The Dinner Date Experience takes place on the ranch as the sun goes down. The horses are in the pasture. The Highlands are out in the field. The sky does what Kansas skies do in the evening. It&rsquo;s the kind of setting that makes the conversation happen naturally &mdash; not because you planned it, but because the place slows everything down.</p><p>Couples book this for anniversaries, milestone birthdays, Valentine&rsquo;s Day, and date nights where a restaurant just won&rsquo;t cut it. Most say it&rsquo;s the most memorable evening they&rsquo;ve had in Kansas &mdash; not because of what they ate, but because of what the setting made possible. A real moment of presence. Away from the city, the routine, the noise.</p><p>The Rusty Saddle Bar is on site. The setting is private. And you can combine the dinner date with a treehouse or covered wagon stay for a full overnight getaway.</p><h2>Booking the Dinner Date</h2><p>By reservation &mdash; call or text (316) 303-6195. Spring and fall weekends book fast. If you&rsquo;re planning for an anniversary or holiday, call ahead. We&rsquo;ll tell you what&rsquo;s available and what&rsquo;s included.</p><h2>Where Are We?</h2><p>Diamond Springs Ranch, 1734 SE 96th St, Sedgwick, KS 67135. About 15 minutes north of Wichita. Fully insured, reservation-only.</p><p>More to explore: <a href="/guided-horseback-rides/">Guided Horseback Rides</a>, <a href="/highland-cattle-experience/">Highland Cattle Experience</a>, <a href="/luxury-treehouse-stay/">Luxury Treehouse Stay</a>, <a href="/covered-wagon-stay/">Covered Wagon Stay</a>, <a href="/private-events/">Private Events</a>. See all <a href="/services/">ranch experiences</a> and <a href="/service-areas/">areas we serve</a>.</p>',
